...
class HashUtility {
    ...
    public static function getUser($hash){
        $whereClause = "AND CAST(SHA1(CONCAT(username, '::', tx_cdsrcbepwreset_resetHash, '::" .md5($GLOBALS['TYPO3_CONF_VARS']['SYS']['encryptionKey'])."')) AS CHAR) = " . $GLOBALS['TYPO3_DB']->fullQuoteStr($hash);
